...
macro(set_dependency list_deps)
  ...
  foreach(arg ${ARGV})
    ...
    elseif(arg STREQUAL "pat")
      ...
      list(APPEND target_global_libs ${PAT_LIBRARIES})
...
macro(get_all_files_for_build folders)
...
macro(add_application project_name fldrs)
    ...
    add_executable(${project_name} ${target_global_code} ${target_mocs_obj})
    target_link_libraries(${project_name} ${target_global_libs})
...
macro(add_static_library project_name fldrs)
    project(${project_name})
    ...
    add_library(${project_name} STATIC ${target_global_code} ${target_mocs_obj})
    target_link_libraries(${project_name} ${target_global_libs})
